---
description: how to restart the dev server when config, scripts, or environment changes require it
---
...
> **You (Antigravity) are responsible for restarting the dev server** whenever a change requires it.
